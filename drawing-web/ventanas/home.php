		...
		<section id="sectionFiles">
			...
			<div id="contenido">
				<ul id="imagenesGaleria">
					...
					<li class="imagenesH">
						<img src="../save/snd-yvv/dibujoDrawW1687.png" alt="" onclick="mostrarImagen(this)">
						<p class="nombreImagenG">mi primer dibujo</p>
						<p class="fechaImagenG">2016/08/01</p>
					</li>
					<li class="imagenesH">
						<img src="../save/snd-yvv/dibujoDrawW2092.png" alt="" onclick="mostrarImagen(this)">
						<p class="nombreImagenG">Trazos suaves</p>
						<p class="fechaImagenG">2016/08/03</p>
					</li>
				</ul>
			</div>
		</section>
